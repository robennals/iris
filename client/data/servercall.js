...
export async function reportAbuseAsync({community, thing, thingType, abuseType, details}) {
    return await callServerApiAsync('reportAbuse', {community, thing, thingType, abuseType, details});
}
...
export async function editPostTopicAsync({community, topic, name, pinned, summary, questions}) {
